...
public class Activityact2Activity extends ExpandableListActivity {
	...
	//Initialize variables
				  ...
				  // Set values in parent class object
				      if(i==1){
				    	  ...
				    	  final Child child = new Child();
			    		   ...
			    		   parent.setName("" + i);
					       parent.setText1("Jalisco");
					       //parent.setText2("Auto disable/enable App \n at specified time");
					       parent.setChildren(new ArrayList<Child>());
					       
					       final Child child = new Child();
							child.setName("" + i);
							child.setText1("Lagos de Moreno");
							parent.getChildren().add(child);
			    		   ...
			    		   parent.setName("" + i);
					       parent.setText1("Oaxaca");
					       //parent.setText2("Show App Icon on \nnotification bar");
					       parent.setChildren(new ArrayList<Child>());
					       
					       final Child child = new Child();
							child.setName("" + i);
							child.setText1("Huajuapan"); 
							parent.getChildren().add(child);
						   final Child child1 = new Child();
							child1.setName("" + i);
							child1.setText1("Juchitán");
							parent.getChildren().add(child1);
						  final Child child2 = new Child();
							child2.setName("" + i);
							child2.setText1("Tuxtepec");
							parent.getChildren().add(child2);
						   final Child child3 = new Child();
							child3.setName("" + i);
							child3.setText1("Salina Cruz");
							parent.getChildren().add(child3);
			        	  }
				
			    	   else if(i==4){
			    		   parent.setName("" + i);
					       parent.setText1("Veracruz");
					       //parent.setText2("Show App Icon on \nnotification bar");
					       parent.setChildren(new ArrayList<Child>());
					       
					       final Child child = new Child();
							child.setName("" + i);
							child.setText1("Tuxpan"); 
							parent.getChildren().add(child);
						   final Child child1 = new Child();
							child1.setName("" + i);
							child1.setText1("Poza Rica");
							parent.getChildren().add(child1);
			        	  }
		...
		private class MyExpandableListAdapter extends BaseExpandableListAdapter
		{
			...
			public MyExpandableListAdapter()
			{
				...
				inflater = LayoutInflater.from(Activityact2Activity.this);
			}
